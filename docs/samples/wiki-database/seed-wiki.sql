...
-- Run with: sqltxt script --db ./WikiDb docs/samples/wiki-database/seed-wiki.sql
-- Prerequisite: create-wiki.sql must have been run first
...
INSERT INTO PageContent (Id, PageId, Content, Version, CreatedById, CreatedAt) VALUES ('1', '1', 'Welcome to the sample Wiki. This is the home page.', 1, '1', '2026-03-17T12:00:00Z');
INSERT INTO PageContent (Id, PageId, Content, Version, CreatedById, CreatedAt) VALUES ('2', '2', 'About this Wiki. Built with SQL.txt.', 1, '1', '2026-03-17T12:05:00Z');
